...
import { weiToEther } from "../auction/_components";
...
const Auction: NextPage = () => {
  ...
  const { queryAccountNFT, addAuctionCollectible, queryNFTById, updateAuctionNTFOwner, updateNFTCollectibleOwner } = GraphqlServer();
